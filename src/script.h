...
#ifndef H_WYVERN_SCRIPT
#define H_WYVERN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CwyvernAddress
 */
...
public:
    ...
    // Pre-version-0.6, wyvern always counted CHECKMULTISIGs
